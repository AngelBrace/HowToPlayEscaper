...
| `09-baffleshots-navops.jpg` | **Nav OPS** terminal with BaffleShots UI (fleet setup with **Nav Plan** / mines, Settings with Group Sink + Sea Mines, **Confirm / Waiting… / Start**, or battle / game-over reveal on the target grid). |
